...
// Verify entered credentials from DB and return a JWT Token along with user details and verification status IF MFA IS DISABLED
...
// This api will create a DB entry for the user with the provided data and an additional flag of verified=false
// An email will be sent to the user to confirm their account
